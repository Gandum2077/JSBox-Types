...
interface Location {
  available: boolean;
  fetch(options: {
    handler: (resp: LocationTypes.LocationResponse) => void;
  }): void;
  startUpdates(options: {
    handler: (resp: LocationTypes.LocationResponse) => void;
  }): void;
  trackHeading(options: {
    handler: (resp: LocationTypes.HeadingResponse) => void;
  }): void;
  stopUpdates(): void;
  select(options: {
    handler: (result: LocationTypes.SelectResult) => void;
  }): void;
