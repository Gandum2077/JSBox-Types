...
interface Http {
  ...
  // 返回Promise的异步形式
  request(
    options: Omit<HttpTypes.HttpRequestOptions, "handler">
  ...
  download(
    options: Omit<HttpTypes.DownloadOptions, "handler">
  ): Promise<HttpTypes.DownloadResponse>;
  upload(
    options: Omit<HttpTypes.UploadOptions, "handler">
  ): Promise<HttpTypes.HttpResponse>;
