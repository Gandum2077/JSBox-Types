...
namespace PrefsTypes {
    ...
    interface PrefsItem {
        title: string;
        type: string; // string, password, number, boolean, slider, list, info, link, script, child.
        key: string;
        value?: any;
        placeholder?: string;
    ...
    type allPrefsItemTypes = PrefsItemString | PrefsItemPassword
        | PrefsItemNumber | PrefsItemBoolean | PrefsItemSlider
        | PrefsItemList | PrefsItemInfo | PrefsItemLink
        | PrefsItemScript | PrefsItemChild;
}
