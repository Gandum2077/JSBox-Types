...
declare function $color(
  lightColor: string | UIColor,
  darkColor: string | UIColor
): UIColor;
...
declare function $image(
  lightModeSource: string | UIImage,
  darkModeSource: string | UIImage
): UIImage;
declare function $image(
...
declare function $accessibilityAction(
  name: string,
  handler: () => void
